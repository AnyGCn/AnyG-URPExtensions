...
namespace ResidentDrawer
{
    ...
    internal struct CullingJob : IJobParallelFor
    {
        ...
        unsafe float CalculateLODVisibility(int instanceIndex, int sharedInstanceIndex, InstanceFlags instanceFlags)
        {
            ...
            {
                ref readonly AABB worldAABB = ref UnsafeUtility.ArrayElementAsRef<AABB>(instanceData.worldAABBs.GetUnsafePtr(), instanceIndex);
    ...
    internal unsafe struct PrefixSumDrawsAndInstances : IJob
    {
        ...
        unsafe public void Execute()
        {
            ...
            bool allowIndirect = false; // indirectBufferLimits.maxInstanceCount > 0;
            ...
            for (;;)
            {
                ...
                for (int rangeIndex = 0; rangeIndex < drawRanges.Length; ++rangeIndex)
                {
                    ...
                    bool isIndirect = false; // allowIndirect && drawRangeInfo.key.supportsIndirect;
